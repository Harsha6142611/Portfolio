  ...
  <div className="absolute top-0 left-0 hidden group-hover:flex items-center justify-center w-full h-full">
    ...
    />
      ...
      <div className="flex items-center justify-between mb-4">
        ...
        <a href={link} className="text-gray-400 hover:text-blue-400 transition-colors" target="_blank">
          <ExternalLink className="w-5 h-5" />
        </a>
        {githubLink && (
        <a href={githubLink} className="hover:text-blue-400 transition-colors flex items-center gap-2 hover:scale-110 transform duration-200" target="_blank">
